...
namespace RpgLibrary.WorldClasses
{
    public class MapData
    {
        ...
        public MapData(string mapName, List<TilesetData> tilesets, AnimatedTilesetData animatedSet, List<MapLayerData> layers, CollisionLayer collisionLayer, AnimatedTileLayer animatedLayer)
        {
            MapName = mapName;
