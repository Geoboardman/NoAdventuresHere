...
using Sanctuary.GameScreens;

namespace Sanctuary.Components
{
    public class Player
    {
        #region Field Region
        ...
        private void UpdatePosition(GameTime gameTime, Vector2 motion)
        {
            ...
            foreach (Character c in GamePlayScreen.World.Levels[GamePlayScreen.World.CurrentLevel].Characters)
            {
                Rectangle r = new Rectangle(
